...
<xsl:template match="tips_user">
 <tr>
  ...
  <td style="width:10%"><a href="/omp?cmd=user_delete&amp;login={./username}&amp;token={/envelope/token}" onclick="javascript:return confirm('确定要删除该用户吗？')">删除</a></td>
  <td><a href="/omp?cmd=user_modify_page&amp;login={./username}&amp;token={/envelope/token}&amp;userrole={userrole}" onclick="javascript:return confirm('确定要修改该用户吗？')">修改</a></td>
 </tr>
</xsl:template>
...
<xsl:template match="list">
 <tr>
  ...
  <td style="width:20%"><a href="/omp?cmd=data_rebuild&amp;BackID={./backid}&amp;tips_table={./tips_table}&amp;token={/envelope/token}&amp;bak_time={//baktime}&amp;bak_name={//bakname}&amp;pagenum={//nowpage}" onclick="javascript:return confirm('确定要恢复数据吗？')">恢复</a></td>
  <td><a href="/omp?cmd=data_delete&amp;BackID={./backid}&amp;tips_table={./tips_table}&amp;token={/envelope/token}&amp;bak_time={//baktime}&amp;bak_name={//bakname}&amp;pagenum={//nowpage}" onclick="javascript:return confirm('确定要删除数据吗？')">删除</a></td>
 </tr>
</xsl:template>
 ...
 <td class="tag">流出数据(KB)：</td>
	 ...
	 <td>
      <select name="tips_Protocol" class="shortText">
        ...
        <option value="59">TVUPLAYER</option>
        <option value="60">VEOHTV</option>
        <option value="61">QQLIVE</option>
        <option value="62">THUNDER</option>
        <option value="63">SOULSEEK</option>
        <option value="64">GADUGADU</option>
        <option value="65">IRC</option>
        <option value="66">POPO</option>
        <option value="67">JABBER</option>
        <option value="68">MSN</option>
        <option value="69">OSCAR</option>
        <option value="70">YAHOO</option>
        <option value="71">BATTLEFIELD</option>
        <option value="72">QUAKE</option>
        <option value="73">SECONDLIFE</option>
        <option value="74">STEAM</option>
        <option value="75">HL2</option>
        <option value="76">WORLDOFWARCRAFT</option>
        <option value="77">TELNET</option>
        <option value="78">STUN</option>
        <option value="79">IPSEC</option>
        <option value="80">GRE</option>
        <option value="81">ICMP</option>
        <option value="82">IGMP</option>
        <option value="83">EGP</option>
        <option value="84">SCTP</option>
        <option value="85">OSPF</option>
        <option value="86">IPIP</option>
        <option value="87">RTP</option>
        <option value="88">RDP</option>
        <option value="89">VNC</option>
        <option value="90">PCANYWHERE</option>
        <option value="91">SSL</option>
        <option value="92">SSH</option>
        <option value="93">USENET</option>
        <option value="94">MGCP</option>
        <option value="95">IAX</option>
        <option value="96">TFTP</option>
        <option value="97">AFP</option>
        <option value="98">STEALTHNET</option>
        <option value="99">AIMINI</option>
        <option value="100">SIP</option>
        <option value="101">TRUPHONE</option>
        <option value="102">ICMPV6</option>
        <option value="103">DHCPV6</option>
        <option value="104">ARMAGETRON</option>
        <option value="105">CROSSFIRE</option>
        <option value="106">DOFUS</option>
        <option value="107">FIESTA</option>
        <option value="108">FLORENSIA</option>
        <option value="109">GUILDWARS</option>
        <option value="110">HTTPACTIVESYNC</option>
        <option value="111">KERBEROS</option>
        <option value="112">LDAP</option>
        <option value="113">MAPLESTORY</option>
        <option value="114">MSSQL</option>
        <option value="115">PPTP</option>
        <option value="116">WARCRAFT3</option>
        <option value="117">WOKF</option>
        <option value="118">MEEBO</option>
     </select>
	 </td>
...
<xsl:template match="list" mode="dialog_list">
 <tr>
  <td style="width:10px;"><image src="img/style/close.png" class="openCloseImg"/></td>
  <td style="width:20%;"><xsl:value-of select="./Sip"/></td>
  <td style="width:20%;"><xsl:value-of select="./Sport"/></td>
...
<td colspan="5">
  外部主机ip:<xsl:value-of select="./Dip"/><br/>
外部主机端口：<xsl:value-of select="./Dport"/><br/>
 通信结束时间:<xsl:value-of select="./End_time"/><br/>
  流出数据(KB):<xsl:value-of select="./Load"/>
</td></tr>
</xsl:template>
...
<div class="divBlock">
<div>
		<div id="tasks" style="margin-top:5px">验证插件:
		<form action="/omp" method="post" enctype="multipart/form-data">
		   <input type="hidden" name="token" value="{/envelope/token}"/>
		   <input type="hidden" name="cmd" value="upgrade"/>
		   <input type="hidden" name="caller" value="{/envelope/caller}"/>
		<div id="div2_1" style="text-align:left;margin:-17px 0 0 60px">
			<input id="file21" name="tipsnvt:1"  type="file" onclick="UpFile2(1)" />
		</div>
		<div id="FileList2" style="text-align:left;margin:0px 0 0 60px"></div>
		<div style="text-align:left;padding-left:328px">
			<input type="submit" name="submit" value="导 入 "/>
		</div>
		</form>
		</div>
		<script type="text/javascript" language="javascript" src="/script/jquery-1.6.2.min.js"/>
</div>
   <div class="title"><div class="title_icon"></div>系统操作</div>
   <div class="content">
    <p class="heighTr" style="text-align:center">
