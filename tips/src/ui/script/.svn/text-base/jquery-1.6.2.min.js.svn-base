...
function DelProjectAjdunt(divId) {
	    $("#div_" + divId).empty();
}

function UpFile(oldId) {
	var d = $("#ad_" + oldId).html();
	if (d == undefined) {
	//var newId = new Date().getTime();
	var newId = oldId+1;
	
	$("#div_" + oldId).append("  <a id='ad_" + oldId + "' href='javascript:void(0);' onclick='DelProjectAjdunt(" + oldId + ")'>删除</a>");
    $("#FileList").append("<div id='div_" + newId + "'><input  id=" + newId + " name=tipsnvt:" + newId + " type='file' onclick='UpFile(" + newId + ")' /> </div>");
    }

}


function DelProjectAjdunt2(divId) {
	    $("#div2_" + divId).empty();
}

function UpFile2(oldId) {
	var d = $("#ad2_" + oldId).html();
	if (d == undefined) {
	//var newId = new Date().getTime();
	var newId = oldId+1;
	
	$("#div2_" + oldId).append("  <a id='ad2_" + oldId + "' href='javascript:void(0);' onclick='DelProjectAjdunt2(" + oldId + ")'>删除</a>");
    $("#FileList2").append("<div id='div2_" + newId + "'><input  id=" + newId + " name=tipsnvt:" + newId + " type='file' onclick='UpFile2(" + newId + ")' /> </div>");
    }

}

function DelProjectAjdunt3(divId) {
	    $("#div3_" + divId).empty();
}

function UpFile3(oldId) {
	var d = $("#ad3_" + oldId).html();
	if (d == undefined) {
	//var newId = new Date().getTime();
	var newId = oldId+1;
	
	$("#div3_" + oldId).append("  <a id='ad3_" + oldId + "' href='javascript:void(0);' onclick='DelProjectAjdunt3(" + oldId + ")'>删除</a>");
    $("#FileList3").append("<div id='div3_" + newId + "'><input  id=" + newId + " name=tipsnvt:" + newId + " type='file' onclick='UpFile3(" + newId + ")' /> </div>");
    }
