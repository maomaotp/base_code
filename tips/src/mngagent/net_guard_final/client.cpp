...
char * Device_ID = config.device_id;
...
//		cout<<4<<endl;
	...
	unused_handle = unused_handle; if(id){}; if(type){}; if(description){}; encoding = encoding;		//hyj 靠靠
	return (void*)fd;
}
...
//cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl;
	...
	soap = soap; handle = handle;		//hyj 靠靠
	return SOAP_OK;
}
