...
//     printf("=======%s=======\n",(state.__ptr[0]).type);
	...
	{
		cout<<"send to server OK !(get_time)"<<endl;
	//	cout<<"resultlist->__size = "<<resultlist.__size<<endl;
	//	cout<<"the geted time is :"<<resultlist.__ptr[0]->TimeStamp<<endl;
		time = resultlist.__ptr[0]->TimeStamp;
	}
	else
	{
		cout<<"send to server failed !(get_time)"<<endl;
		result = -1;
		client_end(&soap);
		return result; 
	}
...
cout<<"===lwd=====================1="<<endl;
	if(soap_call_ns__upload_message(&soap,Server, NULL, Device_ID,1,&state,t_auth_str,&resultlist) == SOAP_OK)
	{
	     cout<<"send to server OK !(send_status)"<<endl;
	//     cout<<"resultlist->__size = "<<resultlist.__size<<endl;
//	     cout<<resultlist.__ptr[0].TimeStamp<<"  "<<resultlist.__ptr[0].Order<<"  "<<resultlist.__ptr[0].Param<<endl;
	...
	{
		cout<<"send to server failed !(send_status)"<<endl;
		client_end(&soap);
		return -1;
	}
...
//cout<<"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@senddata"<<endl;
	...
	{
		cout<<"send to server OK !(send_data)"<<endl;
	//	cout<<"resultlist->__size = "<<resultlist.__size<<endl;
//		cout<<resultlist.__ptr[0].TimeStamp<<"  "<<resultlist.__ptr[0].Order<<"  "<<resultlist.__ptr[0].Param<<endl;
	}
	else
	{
		cout<<"send to server failed !(send_data)"<<endl;
		result = -1;
	}
...
//cout<<"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@senddata1"<<endl;
	...
	if(soap_call_ns__upload_message(&soap,Server,NULL,Device_ID,0,&state,t_auth_str,&resultlist) == SOAP_OK)
	{
		cout<<"send to server OK !(send_data1)"<<endl;
	//	cout<<"resultlist->__size = "<<resultlist.__size<<endl;
//		cout<<resultlist.__ptr[0].TimeStamp<<"  "<<resultlist.__ptr[0].Order<<"  "<<resultlist.__ptr[0].Param<<endl;
	}
	else
	{
		cout<<"send to server failed !(send_data1)"<<endl;
		result = -1;
	}
...
int SendConfig(struct config_struct* config,char* cmdbuff)
{
	...
	if(soap_call_ns__upload_message(&soap,Server, NULL, Device_ID,0,&state,t_auth_str,&resultlist) == SOAP_OK)
	{
		cout<<"send to server OK !(send_config)"<<endl;
	//	cout<<"resultlist->__size = "<<resultlist.__size<<endl;
//		cout<<resultlist.__ptr[0].TimeStamp<<"  "<<resultlist.__ptr[0].Order<<"  "<<resultlist.__ptr[0].Param<<endl;
/*		if(resultlist.__size == 0)
			command_len = 0;
...
*/
	...
	{
		cout<<"send to server failed !(send_config)"<<endl;
		result = -1;
	}
