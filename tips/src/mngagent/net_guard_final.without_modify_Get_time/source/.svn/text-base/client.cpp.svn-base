	...
	switch(type)
	{
		...
		case 1://alert
		{
			...
			for(i=0;i<size;i++)
			{
				...
				strcpy((state->__ptr+i)->msg,temp);
			cout<<"11111111111111111111111111111111111111"<<endl<<temp<<endl;
			}
			break;
		}
		case 2://senstive_alert
		{
			...
			for(i=0;i<size;i++)
			{
				...
				strcpy((state->__ptr+i)->msg,temp);
				cout<<"222222222222222222222222222222222222"<<endl<<temp<<endl;
			}
			break;
		}
...
cout<<"33333333333333333333333333333333333"<<endl<<temp<<endl;;
