...
int Set_status_shm(shm_struct_t * shm, int id, void * param, int len)
{
//	printf("var[%d].type=%d\n", id, shm->var[id].type);
//	printf("var[%d].num=%d\n", id, shm->var[id].num);
...
int Get_status_shm(shm_struct_t * shm, int id, void * param, int len)
{
	...
	if(len < size)
	{
		printf("your buffer not enough, so get status:%d failed\n", id);
		return -1;
	}
...
void Set_pid_shm(shm_struct_t * shm, int process)
{
	...
	{
		case DAEMONPID:
						Set_status_shm(shm, 52, &pid, sizeof(pid));
						break;
		case ALARMPID:
						Set_status_shm(shm, 53, &pid, sizeof(pid));
						break;
		case AUDITPID:
						Set_status_shm(shm, 54, &pid, sizeof(pid));
						break;
		case BLOCKPID:
						Set_status_shm(shm, 55, &pid, sizeof(pid));
						break;
		case SENSTPID:
						Set_status_shm(shm, 56, &pid, sizeof(pid));
						break;
		case CACHEPID:
						Set_status_shm(shm, 57, &pid, sizeof(pid));
						break;
		case MNGAGNTPID:
						Set_status_shm(shm, 58, &pid, sizeof(pid));
						break;
		case UIPID:
						Set_status_shm(shm, 59, &pid, sizeof(pid));
						break;
		case NETSTATPID:
						Set_status_shm(shm, 60, &pid, sizeof(pid));
						break;
		case PREALLOC1PID:
						Set_status_shm(shm, 61, &pid, sizeof(pid));
						break;
		case PREALLOC2PID:
						Set_status_shm(shm, 62, &pid, sizeof(pid));
						break;
		default:
						printf("no such process in shm\n");
						break;
	}
}
int Get_pid_shm(shm_struct_t * shm, int process)
{
	...
	{
		case DAEMONPID:
						Get_status_shm(shm, 52, &pid, sizeof(pid));
						break;
		case ALARMPID:
						Get_status_shm(shm, 53, &pid, sizeof(pid));
						break;
		case AUDITPID:
						Get_status_shm(shm, 54, &pid, sizeof(pid));
						break;
		case BLOCKPID:
						Get_status_shm(shm, 55, &pid, sizeof(pid));
						break;
		case SENSTPID:
						Get_status_shm(shm, 56, &pid, sizeof(pid));
						break;
		case CACHEPID:
						Get_status_shm(shm, 57, &pid, sizeof(pid));
						break;
		case MNGAGNTPID:
						Get_status_shm(shm, 58, &pid, sizeof(pid));
						break;
		case UIPID:
						Get_status_shm(shm, 59, &pid, sizeof(pid));
						break;
		case NETSTATPID:
						Get_status_shm(shm, 60, &pid, sizeof(pid));
						break;
		case PREALLOC1PID:
						Set_status_shm(shm, 61, &pid, sizeof(pid));
						break;
